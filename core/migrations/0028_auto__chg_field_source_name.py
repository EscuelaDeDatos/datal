...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ao_sources', 'name', self.gf('django.db.models.fields.CharField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'Source.name'
        db.alter_column('ao_sources', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        u'core.datasetrevision': {
            ...
            'doc': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
