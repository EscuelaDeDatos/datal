...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.account'
        db.add_column('ao_sources', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Account'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.account'
        db.delete_column('ao_sources', 'account_id')
